  ...
  useEffect(() => {
    const fetchTime = async () => {
      try {
        ...
        const endpoint = `/api/timezone?zone=${encodeURIComponent(
          tz.timezone
        )}`;
    ...
    <div className="timezone-card">
      <div className="card-header">
        <p className="location-info-display">
          <span className="city-country-display">{formatDisplayName(city)}</span>
      ...
      <div className="card-actions">
        <button className="remove-button" onClick={() => onRemove(tz.id)}>
          Remove
        </button>
        {/* <button 
        ...
        {businessStatus ? (
          <div className="categories-container">
            <p className="category">
              ...
              <span
                className={
                  businessStatus["Private Offices"] === "Open"
                    ? "tag open"
                    : "tag closed"
                }
              >
                {businessStatus["Private Offices"]}
              </span>
            </p>
            <p className="category">
              Public Offices:{" "}
              <span
                className={
                  businessStatus["Public Offices"] === "Open"
                    ? "tag open"
                    : "tag closed"
                }
              >
                {businessStatus["Public Offices"]}
              </span>
            </p>
            <p className="category">
              Shops:{" "}
              <span
                className={
                  businessStatus["Shops"] === "Open" ? "tag open" : "tag closed"
                }
              >
                {businessStatus["Shops"]}
              </span>
            </p>
            <p className="category">
              Bars:{" "}
              <span
                className={
                  businessStatus["Bars"] === "Open" ? "tag open" : "tag closed"
                }
              >
                {businessStatus["Bars"]}
              </span>
            ...
            <p className="category">
              ...
              <span
                className={
                  businessStatus["Restaurants"] === "Open"
                    ? "tag open"
                    : "tag closed"
                }
              >
                {businessStatus["Restaurants"]}
              </span>
            </p>
            <p className="category">
              Public Transport:{" "}
              <span
                className={
                  businessStatus["Public Transport"] === "Open"
                    ? "tag open"
                    : "tag closed"
                }
              >
                {businessStatus["Public Transport"]}
              </span>
            </p>
          </div>
        ) : (
